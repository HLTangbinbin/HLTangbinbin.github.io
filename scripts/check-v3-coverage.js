...
const v3PageRegistry = {
  CityGDP: { source: { localJson: './city.json', cityCodeArr: CITY_CODES, needAddCityCodeArr_yd: ADD_CITY_CODES_YD, needAddCityCodeArr_nd: ADD_CITY_CODES_ND }, charts: [regionChart('city-gdp', '重点城市地区生产总值', ['city_gdp'], 'nd')] },
  CityPopulation: { source: { localJson: './city.json', cityCodeArr: CITY_POPULATION_CODES }, charts: [regionChart('city-population', '重点城市年末户籍人口', ['city_registered_population'], 'nd')] },
  CityFinance: { source: { localJson: './city.json', cityCodeArr: CITY_CODES, needAddCityCodeArr_yd: ADD_CITY_CODES_YD, needAddCityCodeArr_nd: ADD_CITY_CODES_ND }, charts: [regionChart('city-budget-income', '重点城市地方一般公共预算收入', ['city_budget_income'], 'nd'), regionChart('city-budget-expenditure', '重点城市地方一般公共预算支出', ['city_budget_expenditure'], 'nd'), regionChart('city-budget-deficit', '重点城市地方一般公共预算赤字', ['city_budget_deficit'], 'nd'), regionChart('city-deposit', '重点城市住户存款余额', ['city_household_deposit_balance'], 'nd')] },
  CityRealEstateInvest: { source: { localJson: './city.json', cityCodeArr: CITY_CODES, needAddCityCodeArr_yd: ADD_CITY_CODES_YD, needAddCityCodeArr_nd: ADD_CITY_CODES_ND }, charts: [regionChart('city-invest', '重点城市房地产开发住宅投资额', ['city_residential_dev_investment'], 'nd')] },
  CityRealEstateSell: { source: { localJson: './city.json', cityCodeArr: CITY_CODES, needAddCityCodeArr_yd: ADD_CITY_CODES_YD, needAddCityCodeArr_nd: ADD_CITY_CODES_ND }, charts: [regionChart('city-sales-area', '重点城市住宅商品房销售面积', ['city_residential_sales_area'], 'nd'), regionChart('city-avg-price', '重点城市住宅商品房平均销售价格', ['city_residential_avg_price'], 'nd')] },
  CityRealEstatePriceIndices: { source: { localJson: './city.json', cityCodeArr: CITY_CODES, needAddCityCodeArr_yd: ADD_CITY_CODES_YD, needAddCityCodeArr_nd: ADD_CITY_CODES_ND }, charts: [regionChart('city-new-house-mom', '新建商品住宅价格指数(上月=100)', ['city_new_house_price_mom'], 'yd'), regionChart('city-new-house-yoy', '新建商品住宅价格指数(上年同月=100)', ['city_new_house_price_yoy'], 'yd'), regionChart('city-second-hand-yoy', '二手住宅价格指数(上年同月=100)', ['city_second_hand_house_price_yoy'], 'yd'), regionChart('city-second-hand-mom', '二手住宅价格指数(待复核项)', ['city_second_hand_house_price_mom_unverified'], 'yd')] },
  CityEducation: { source: { localJson: './city.json', cityCodeArr: CITY_CODES, needAddCityCodeArr_yd: ADD_CITY_CODES_YD, needAddCityCodeArr_nd: ADD_CITY_CODES_ND }, charts: [regionChart('city-college-students', '重点城市普通本专科在校学生数', ['city_college_students'], 'nd')] },
  CityMedical: { source: { localJson: './city.json', cityCodeArr: CITY_CODES, needAddCityCodeArr_yd: ADD_CITY_CODES_YD, needAddCityCodeArr_nd: ADD_CITY_CODES_ND }, charts: [regionChart('city-hospital-count', '重点城市医院数', ['city_hospital_count'], 'nd')] },
  ProvincialGDP: { source: { localJson: './province.json', cityCodeArr: PROVINCE_CODES, needAddCityCodeArr: ADD_PROVINCE_CODES }, charts: [regionChart('province-gdp', '重点省市地区生产总值', ['province_gdp'], 'nd')] },
  ProvincialPopulation: { source: { localJson: './province.json', cityCodeArr: PROVINCE_CODES, needAddCityCodeArr: ADD_PROVINCE_CODES }, charts: [regionChart('province-total-population', '重点省市年末常住人口', ['province_total_population'], 'nd'), regionChart('province-birth-rate', '重点省市人口出生率', ['province_birth_rate'], 'nd'), regionChart('province-death-rate', '重点省市人口死亡率', ['province_death_rate'], 'nd'), regionChart('province-natural-growth', '重点省市人口自然增长率', ['province_natural_growth_rate'], 'nd')] },
  ProvincialFinance: { source: { localJson: './province.json', cityCodeArr: PROVINCE_CODES, needAddCityCodeArr: ADD_PROVINCE_CODES }, charts: [regionChart('province-budget-income', '重点省市地方财政一般预算收入', ['province_budget_income'], 'nd'), regionChart('province-budget-expenditure', '重点省市地方财政一般预算支出', ['province_budget_expenditure'], 'nd'), regionChart('province-budget-deficit', '重点省市地方财政一般预算赤字', ['province_budget_deficit'], 'nd')] },
  ProvincialRealEstateInvest: { source: { localJson: './province.json', cityCodeArr: PROVINCE_CODES, needAddCityCodeArr: ADD_PROVINCE_CODES }, charts: [regionChart('province-invest-year', '重点省市房地产开发住宅投资额', ['province_residential_dev_investment'], 'nd'), regionChart('province-invest-value', '重点省市住宅投资累计值', ['province_residential_investment_value'], 'yd'), regionChart('province-invest-growth', '重点省市住宅投资累计增长', ['province_residential_investment_growth'], 'yd')] },
  ProvincialRealEstateSell: { source: { localJson: './province.json', cityCodeArr: PROVINCE_CODES, needAddCityCodeArr: ADD_PROVINCE_CODES }, charts: [regionChart('province-sales-area-year', '重点省市住宅商品房销售面积', ['province_residential_sales_area'], 'nd'), regionChart('province-avg-price-year', '重点省市住宅商品房平均销售价格', ['province_residential_avg_price'], 'nd'), regionChart('province-sales-area-value', '重点省市住宅销售面积累计值', ['province_residential_sales_area_value'], 'yd'), regionChart('province-sales-area-growth', '重点省市住宅销售面积累计增长', ['province_residential_sales_area_growth'], 'yd'), regionChart('province-sales-amount-value', '重点省市住宅销售额累计值', ['province_residential_sales_amount_value'], 'yd'), regionChart('province-sales-amount-growth', '重点省市住宅销售额累计增长', ['province_residential_sales_amount_growth'], 'yd')] },
  ProvincialEducation: { source: { localJson: './province.json', cityCodeArr: PROVINCE_CODES, needAddCityCodeArr: ADD_PROVINCE_CODES }, charts: [regionChart('province-college-enrollment', '重点省市普通高等学校本科招生数', ['province_college_enrollment'], 'nd'), regionChart('province-college-students', '重点省市普通高等学校本科在校学生数', ['province_college_students'], 'nd'), regionChart('province-college-graduates', '重点省市普通高等学校本科毕(结)业生数', ['province_college_graduates'], 'nd')] },
  ProvincialMedical: { source: { localJson: './province.json', cityCodeArr: PROVINCE_CODES, needAddCityCodeArr: ADD_PROVINCE_CODES }, charts: [regionChart('province-hospital-count', '重点省市医院数', ['province_hospital_count'], 'nd'), regionChart('province-bed-count', '重点省市每万人医疗机构床位数', ['province_bed_count_per_10k'], 'nd')] },
  ProvincialLiving: { source: { localJson: './province.json', cityCodeArr: PROVINCE_CODES, needAddCityCodeArr: ADD_PROVINCE_CODES }, charts: [regionChart('province-income', '重点省市全体居民人均可支配收入', ['province_disposable_income'], 'nd')] }
};
