    ...
    drawChartWithParams(echrtId) {
      ...
      switch (echrtId) {
        case this.EChartType_Indices.PI:
          ...
          basicParams = { echrtId: echrtId, chartType: this.chartType, title: '价格指数', subtitle: subtitle, exceptName: '价格指数', unit: '', legendTop: '25%', gridTop: '40%', dbCode: 'yd', min: '94', max: '101' }
          // A01010G01-CPI 上年同比 A01030G01-CPI 上月环比 A01080101-PPI 上年同比  A01080701-PPI 上月环比
          typeArr = ['A01010G01', 'A01030G01', 'A01080101', 'A01080701'];
          break;
        case this.EChartType_Indices.PM:
          subtitle = 'PMI是一套月度发布的、综合性的经济监测指标体系 \n PMI指数50%为荣枯分水线 \n PMI略大于50,说明经济在缓慢前进 \n PMI略小于50说明经济在慢慢走向衰退',
          basicParams = { echrtId: echrtId, chartType: this.chartType, title: '采购经理指数', subtitle: subtitle, exceptName: '采购经理指数商务活动产出', unit: '', legendTop: '20%', gridTop: '35%', dbCode: 'yd', min: '48', max: '57' }
