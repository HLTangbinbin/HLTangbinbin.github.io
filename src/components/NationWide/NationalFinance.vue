    ...
    drawChartWithParams(echrtId) {
      ...
      switch (echrtId) {
        ...
        case this.EChartType_NationalFinance.FY:
          ...
          basicParams = { echrtId: echrtId, chartType: this.chartType, title: '中央与地方财政收支(亿元)', subtitle: '', exceptName: '', unit: '', legendTop: '10%', gridTop: '30%', dbCode: 'nd' }
        ...
        case this.EChartType_NationalFinance.FR:
          ...
          basicParams = { echrtId: echrtId, chartType: this.chartType, title: '国家财政主要收入项目(亿元)', subtitle: '', exceptName: '国家国内财政收入', unit: '', legendTop: '10%', gridTop: '30%', dbCode: 'nd' }
        ...
        case this.EChartType_NationalFinance.FE:
          ...
          basicParams = { echrtId: echrtId, chartType: this.chartType, title: '国家财政主要支出项目(亿元)', subtitle: '', exceptName: '国家国内财政支出', unit: '', legendTop: '10%', gridTop: '30%', dbCode: 'nd' }
