        ...
        drawChartWithParams(echrtId) {
            ...
            switch (echrtId) {
                ...
                case this.EChartType_ForeignTrade.EX:
                    ...
                    basicParams = { echrtId: echrtId, chartType: this.chartType, title: '中国向各国出口总额', subtitle: '', exceptName: '中国向出口总额', unit: '', legendTop: '10%', gridTop: '25%', sj: '0' }
                ...
                case this.EChartType_ForeignTrade.IM:
                    ...
                    basicParams = { echrtId: echrtId, chartType: this.chartType, title: '中国从各国进口总额', subtitle: '', exceptName: '中国从进口总额', unit: '', legendTop: '10%', gridTop: '25%', sj: '0' }
