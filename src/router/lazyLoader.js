...
const componentMap = {
  ...
  'NationWide/PopulationBasic': () => import('../components/NationWide/PopulationBasic.vue'),
  'NationWide/PopulationSpot': () => import('../components/NationWide/PopulationSpot.vue'),
  ...
  'NationWide/EducationSchool': () => import('../components/NationWide/EducationSchool.vue'),
  'NationWide/EducationTeacher': () => import('../components/NationWide/EducationTeacher.vue'),
  'NationWide/EducationStudent': () => import('../components/NationWide/EducationStudent.vue'),
  ...
  'NationWide/FinancialCurrency': () => import('../components/NationWide/FinancialCurrency.vue'),
  'NationWide/FinancialSocialFinancing': () => import('../components/NationWide/FinancialSocialFinancing.vue'),
  'NationWide/FinancialSecurity': () => import('../components/NationWide/FinancialSecurity.vue'),
  'NationWide/FinancialInsurance': () => import('../components/NationWide/FinancialInsurance.vue'),
